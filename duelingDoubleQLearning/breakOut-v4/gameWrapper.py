...
# This is the process_frame function we implemented earlier
from procesFrame import processFrame as process_frame
...
class GameWrapper:
    ...
    def __init__(self, env_name, no_op_steps=10, history_length=4):
        ...
        # Number of frames to compare and detect the movement
    ...
    def reset(self, evaluation=False):
        ...
        # For the initial state, we stack the first frame four times cause whe don´t have any prior values
